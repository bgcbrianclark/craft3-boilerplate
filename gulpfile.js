...
//basics
config.siteName = "Action Printers";
config.proxyDomain = "action.loc";
      ...
      .pipe(
        notify({
          ...
          message:
            event.type +
            ": " +
            event.path.replace(__dirname, "").replace(/\\/g, "/") +
            " was reloaded",
          //,sound: 'Pop'
          icon: icon
        })
